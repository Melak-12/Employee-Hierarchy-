...
// import { Alert, Avatar, Badge,Modal ,Typography, message} from 'antd';
  ...
  return (
    <div className="navbar fixed top-0 left-0 right-0 z-10">
        ...
        <div className="flex justify-left -mb-8 text-2xl font-bold text-white">
          ...
          <Button  className="-mt-6 p-1 font-sm text-sm mx-3 rounded-3xl  hover:text-slate-600"
            >
                            <i className="far fa-envelope fa-2x text-slate-400  hover:text-green-600" ></i>
              
              <Badge  radius='lg' className='bg-red-600 text-white rounded-4xl -mt-1 hover:bg-green-400'>3</Badge>
          </Button>
          <Button
              className="-mt-6 p-1 font-sm text-sm mx-3 rounded-3xl  hover:bg-green-600 hover:text-slate-600"
            >
                            <i className="far fa-bell fa-2x text-slate-400  hover:text-green-600" ></i>
              
              <Badge  radius='lg' className='bg-red-600 text-white rounded-4xl -mt-1 hover:bg-green-400'>2</Badge>
          </Button>
